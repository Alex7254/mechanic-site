    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t6 = space();
    			div3 = element("div");
    			attr_dev(div0, "class", "hero__white-bg svelte-157o2q0");
    			add_location(div0, file, 7, 4, 187);
    			attr_dev(h1, "class", "hero__header red-header svelte-157o2q0");
    			add_location(h1, file, 9, 6, 258);
    			attr_dev(p, "class", "hero__text light-text svelte-157o2q0");
    			add_location(p, file, 10, 6, 334);
    			attr_dev(span, "class", "button-slanted-content");
    			add_location(span, file, 18, 8, 836);
    			attr_dev(a, "class", "diagonal-button hero__button svelte-157o2q0");
    			attr_dev(a, "href", "#contact-us");
    			add_location(a, file, 17, 6, 767);
    			attr_dev(div1, "class", "hero__content svelte-157o2q0");
    			add_location(div1, file, 8, 4, 223);
    			attr_dev(div2, "class", "hero svelte-157o2q0");
    			add_location(div2, file, 5, 2, 124);
    			attr_dev(div3, "class", "main-bg-img svelte-157o2q0");
    			add_location(div3, file, 23, 2, 964);
    			attr_dev(section, "class", "hero-container d-flex-nw svelte-157o2q0");

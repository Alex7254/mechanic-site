    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (img0.src !== (img0_src_value = "/assets/volkswagen.png")) attr_dev(img0, "src", img0_src_value);
    			attr_dev(img0, "alt", "");
    			add_location(img0, file$4, 8, 4, 252);
    			attr_dev(img1, "class", "cars-serviced__logo svelte-19498q");
    			if (img1.src !== (img1_src_value = "/assets/honda.png")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "");
    			add_location(img1, file$4, 13, 4, 374);
    			attr_dev(img2, "class", "cars-serviced__logo svelte-19498q");
    			if (img2.src !== (img2_src_value = "/assets/ford.png")) attr_dev(img2, "src", img2_src_value);
    			attr_dev(img2, "alt", "");
    			add_location(img2, file$4, 14, 4, 446);
    			attr_dev(img3, "class", "cars-serviced__logo svelte-19498q");
    			if (img3.src !== (img3_src_value = "/assets/nissan.png")) attr_dev(img3, "src", img3_src_value);
    			attr_dev(img3, "alt", "");
    			add_location(img3, file$4, 15, 4, 517);
    			attr_dev(img4, "class", "cars-serviced__logo svelte-19498q");
    			if (img4.src !== (img4_src_value = "/assets/dodge.png")) attr_dev(img4, "src", img4_src_value);
    			attr_dev(img4, "alt", "");
    			add_location(img4, file$4, 16, 4, 590);
    			attr_dev(img5, "class", "cars-serviced__logo svelte-19498q");
    			if (img5.src !== (img5_src_value = "/assets/subaru.png")) attr_dev(img5, "src", img5_src_value);
    			attr_dev(img5, "alt", "");
    			add_location(img5, file$4, 17, 4, 662);
    			attr_dev(div, "class", "cars-serviced__gallery svelte-19498q");
    			add_location(div, file$4, 7, 2, 210);
    			attr_dev(section, "class", "cars-serviced svelte-19498q");
    			attr_dev(section, "id", "cars");
    			add_location(section, file$4, 5, 0, 119);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
